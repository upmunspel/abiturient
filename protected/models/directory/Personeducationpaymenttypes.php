...
class Personeducationpaymenttypes extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'personsepcialities' => array(self::HAS_MANY, 'Personsepciality', 'PaymentTypeID'),
		);
	}
	...
	{
		return array(
    'idEducationPaymentTypes' => 'Id Education Payment Types',
    'EducationPaymentTypesName' => 'Education Payment Types Name',
		);
	}
