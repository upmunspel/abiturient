...
class PersonDocumentTypes extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('idPersonDocumentTypes, IsEntrantDocument, display', 'numerical', 'integerOnly' => true),
    ...
    public function attributeLabels() {
        return array(
            'idPersonDocumentTypes' => 'Код',
            'PersonDocumentTypesName' => 'Назва документа',
            'IsEntrantDocument' => 'Основа для вступу',
