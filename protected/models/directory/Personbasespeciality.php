...
class Personbasespeciality extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('idPersonBaseSpeciality, PersonBaseSpecialityName, PersonBaseSpecialityClasifierCode', 'safe', 'on'=>'search'),
		);
	}
	...
	{
		return array(
    'idPersonBaseSpeciality' => 'Id Person Base Speciality',
    'PersonBaseSpecialityName' => 'Person Base Speciality Name',
    'PersonBaseSpecialityClasifierCode' => 'Person Base Speciality Clasifier Code',
		);
	}
