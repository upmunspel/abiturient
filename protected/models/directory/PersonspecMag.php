...
/**
 * This is the model class for table "personspec_mag".
 *
 * The followings are the available columns in table 'personspec_mag':
 * @property string $FIO
 ...
 */
class PersonspecMag extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return PersonspecMag the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
                        array('idPersonSpeciality','required'),
	...
	public function search()
	{
		...
		$criteria=new CDbCriteria;
                $criteria->compare('idPersonSpeciality',$this->idPersonSpeciality,true);
