...
class WebServices {
    ...
    static private $MSG_EDBO_SEARCH_DENY = "Заборонено виконувати пошук у ЄДБО! sdsdsd";
    static private $MSG_EDBO_EDIT_DENY = "Заборонено виконувати синхронізацію з ЄДБО!aerqwrerwerwer";
    ...
    public static function findPerson($series, $number) {
         Yii::log("asdfsdfsd", CLogger::LEVEL_INFO, 'WebServices::findPerson');
//        if (!Yii::app()->user->checkAccess("wsAllowSearch")) {
