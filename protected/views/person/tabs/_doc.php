    ...
    $this->widget('bootstrap.widgets.TbGridView', array(
        ...
        'columns' => array(
            ...
            array(
                ...
                'name' => 'AtestatValue',
                'editable' => array(
                    'url' => Yii::app()->CreateUrl('documents/atestatvalue'),
                    'placement' => 'right',
                    'inputclass' => 'span1',
                    'type' => 'text',
                    'title' => 'Введіть коректний середній бал докуиенту',
                    'htmlOptions' => array("title" => "Змінити бал"),
                ),
            ),
            array(
...
<script>
     ...
     */
    $('a[rel=Documents_AtestatValue]').editable({'datepicker': {'language': 'uk'}, 
        'type': 'text', 
        'url': '<?php echo Yii::app()->CreateUrl('documents/atestatvalue'); ?>',
        'name': 'AtestatValue', 
        'title': 'Введіть коректний середній бал докуиенту', 
        'mode': 'popup', 
        'placement': 'right', 
