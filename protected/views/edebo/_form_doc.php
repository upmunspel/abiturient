<div class="well">
    ...
    <h3>Відправка документів до бази ЕДЕБО (за напрямом підготовки):</h3>
    <hr />
    <?php $url = Yii::app()->createUrl("edebo/docsend"); ?>
    ...
    <h3>Відправка документів до бази ЕДЕБО (за кодами персон):</h3>
    <hr />
    <?php $url = Yii::app()->createUrl("edebo/docsend"); ?>
    <form action="<?php echo $url; ?>" method="GET">
        <div class="row-fluid">
    ...
    <h3>Відправка документів персон (за напрямом підготовки):</h3>
    <hr />
    <div class="row-fluid">
        <div class="span2">
            <?php
