...
<?php $this->widget('bootstrap.widgets.TbGridView',array(
	...
	'columns'=>array(
                ...
                array('name'=>'SpecialityID', 'value' => '$data->speciality->SpecialityDirectionName',
                        'filter'=>CHtml::listData(Specialities::model()->findAll(), "idSpeciality", "SpecialityDirectionName") ),
