...
//
//		if(isset($_POST['PersonSpecialityView']))
//		{
...
//	}
	...
	{
		$dataProvider=new CActiveDataProvider('PersonSpecialityView');
...
//	{
//		if(isset($_POST['ajax']) && $_POST['ajax']==='person-speciality-view-form')
//		{
