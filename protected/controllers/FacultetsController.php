...
class FacultetsController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Facultets']))
		{
			$model->attributes=$_POST['Facultets'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->idFacultet));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('Facultets');
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='facultets-form')
		{
