...
class PersonbasespecialityController extends Controller
{
	/**
	...
	{
		$model=new Personbasespeciality;
	...
	{
		$model=new Personbasespeciality('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Personbasespeciality']))
			$model->attributes=$_GET['Personbasespeciality'];
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='personbasespeciality-form')
		{
