...
$this->menu=array(
    array('label'=>'Додати ','url'=>Yii::app()->createUrl('preuniversity/person/create'),'icon'=>"icon-plus"),
    array('label'=>'Перелік відомостей', 'url'=>array('/preuniversity/statements/admin'),'icon'=>"icon-list-alt" ),
);
	...
	array(
            ...
            (
                ...
                'update' => array(
                    'label'=>'Редагувати',
                    'icon'=>'pencil',
                    'url'=>'Yii::app()->createUrl("preuniversity/person/update", array("id"=>$data->idPerson))',
                    'options'=>array(
                        'class'=>'btn',
               ...
               'view' => array(
                    ...
                    'icon'=>'icon-th-list',
                    'url'=>'Yii::app()->createUrl("preuniversity/person/view", array("id"=>$data->idPerson))',
                    'options'=>array(
                        'class'=>'btn',
