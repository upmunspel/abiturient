...
<hr>
<h4>Пошук абітурієнта за ПІБ</h4>
<div class="row-fluid form">
    <div class="span12">
        <?php echo CHtml::label("ПІБ:","search[fio]");?>
	<?php echo CHtml::textField("search[fio]","",array("class"=>"span12"));?>
    </div>
    
</div>
Поиск персон по маске ПІБ в базе ЄДБО. При этом латинские символы c, C, i, I и кириллические символы с, С, і, І меняются на ? (знак вопроса - произвольный символ); пробелы на * - произвольный набор символов. 
<hr>
<div class="row-fluid form">
    <div class="span2">
...
<?php if (!empty($searchres)): ?>
 <h4>Результати пошуку у базі ЄДБО за серією та номером документа або ПІБ</h4>   
