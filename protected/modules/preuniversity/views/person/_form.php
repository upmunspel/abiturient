<div class="form">
    ...
    $form = $this->beginWidget('bootstrap.widgets.TbActiveForm', array(
        'id' => 'person-form',
        'action' => $model->isNewRecord ? Yii::app()->createUrl("preuniversity/person/create") : "",
        //'type'=>'horizontal',
    ...
    <div class="row-fluid">
        ...
        <div class="span3" >
            <a href="#" style="width: 180px;" class="thumbnail" rel="tooltip" data-title="Фото абітурієнта">
                ...
                $rpath = realpath(DIR_ROOT.DS."images".DS."Photos".DS."big").DS.$model->PhotoName;
                if (!is_file($rpath)) {
                    $path = Yii::app()->baseUrl . Yii::app()->params['photosBigPath'] . Yii::app()->params['defaultPersonPhoto'];
                }

                echo CHtml::image($path."?r=".time(), 'Фото абітурієнта');
                ?>
            </a>
...
<?php endif; ?>    
    ...
    <p class="help-block"><strong>Напрям підготовки (група)</strong></p>
    <hr>
    <div class="row-fluid" >
         <div class ="span2">
         ...
         <div class ="span4">
            ...
            <?php echo $form->dropDownList($model, 'FacultetID', CHtml::listData(Facultets::model()->findAll(), "idFacultet", "FacultetFullName"), 
                    array('class' => 'span12', "id"=>"FacultetID", 
                        'onchange'=>"PSN.changeFacultet(this,'".Yii::app()->createUrl("personspeciality/speciality")."')")); ?>
        </div>
        <div class ="span6">
            <?php echo $form->labelEx($model, 'idPreuniGroup'); ?>
            <?php echo $form->dropDownList($model, 'idPreuniGroup', Specialities::DropDownMask($model->FacultetID, 1, 1, ""), array('class' => 'span12',"id"=>"idPreuniGroup")); ?>
        </div>
    </div>
