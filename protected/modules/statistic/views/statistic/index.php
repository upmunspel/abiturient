            ...
            <div class="row-fluid">
                ...
                <div class="span6">
                    ...
                    echo CHtml::dropDownList(
                            'QualificationID', "", array("1" => "Бакалавр", "3" => "Спеціаліст", "2" => "Магістр"), array('empty' => '', 'class' => 'span12'));
                    ?>
                </div>
                <div class='span4'>
                    ...
                    echo CHtml::textField(
                            'Date', date('d.m.Y'), array('class' => 'span12 datepicker'));
                    ?>
                ...
                <div class="span10">
                    ...
                    <?php
                    echo CHtml::dropDownList(
                            'secname', "Д.Т. Бікулов", array(
                        "Д.Т. Бікулов" => "Д.Т. Бікулов",
                        "О.А. Проценко" => "О.А. Проценко"
    ...
    <div class="well well-large span6">
        ...
        <div class="form" id="fullstat_block" style="display:none;">
            ...
            <div class="row-fluid">
                ...
                <div class="span7">
                    <?php
                    echo $statdetail_form->checkBoxListRow($smodel, 'modes', array(
                        'budget' => 'На бюджет',
            ...
            <div class="span12 row-fluid">
                <div class='span6'>
                    ...
                    <?php
                    echo CHtml::textField(
                            'DateFrom', date('d.m.Y'), array('class' => 'datepicker span12'));
                    ?>
                ...
                <div class='span6'>
                    ...
                    <?php
                    echo CHtml::textField(
                            'DateTo', date('d.m.Y'), array('class' => 'datepicker span12'));
                    ?>
...
<div class="row-fluid" >
    <div class="well well-large span11">
        ...
        <div id="report_block" style="display:none" class='span12'>
            <div class="span12" >
                <?php echo CHtml::label('Виберіть поля для виведеня у звіті або для формування умови вибірки', 'fields', array('class' => 'span12'));
                ?>
            </div>
            <div class='span12'>
        ...
        <?php if ($is_koatuu) { ?>
                        ...
                        <?php } else { ?>
                            ...
                            <?php
                            echo CHtml::checkBox('condval[' . $i . ']', false, array('id' => 'condval-' . $i, 'disabled' => 'disabled', 'class' => 'rept-checkbox',
                                'value' => "1"));
                            ?>
            ...
            <ul>
                ...
                if (Yii::app()->user->checkAccess('showProperties')) {
                    foreach (Facultets::model()->findAll('1 ORDER BY FacultetFullName') as $faculty) {
                        echo '<li>' . CHtml::link($faculty->FacultetFullName, Yii::app()->CreateUrl("rating/rating/ratingcontacts", array('id' => $faculty->idFacultet)));
                        echo ' (' . CHtml::link('У форматі Excel - html', Yii::app()->CreateUrl("rating/rating/ratingcontacts", array('id' => $faculty->idFacultet, 'toexcel' => 1))) . ')';
                        echo '</li>';
                    }
                } else {
                    ?>
        ...
        <div class="form" id="elderstat_block" style="display:none;">
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <?php
                    echo CHtml::dropDownList(
                            'QualificationID', "", array("3" => "Спеціаліст", "2" => "Магістр"), array('empty' => '', 'class' => 'span12'));
                    ?>
                </div>
            </div>
            <div class="row-fluid">
...
<div class="row-fluid">
    <div class="well well-large span6">
        ...
        <div class="form" id="eldernumstat_block" style="display:none;">
            ...
            <ol><li>факультет, </li>
                ...
                <li>к-сть абітурієнтів, у яких диплом видано ЗНУ того ж року, сумарно по усім формам начання, напрямам і ОКР.</li>
            </ol>
            <?php
    ...
    <div class="well well-large span5">
        ...
        <div class="form" id="eldercontracts_block" style="display:none;">
            ...
            <div class="row-fluid">
                <?php
                echo CHtml::checkBox('select_mode', false, array('value' => "1", 'id' => "SpecMagContracts_select_mode"));
                ?>Умови вибірки:
